...
{url-cl}0.5.26++...++main[Full Changelog]
...
{url-cl}0.5.25++...++0.5.26[Full Changelog]

.Changed
- Raised Java to 21,
  kotlin, kotlinx-coroutines,
  junit, kotest, mockk, jococo, assertj-core,
  gradle,
  gradle plugins versions, maven-publish, git-publish, dokka, reckon, sonarqube,
  github actions cache, checkout, setup-java, upload-artifact
...
{url-cl}0.5.22++...++0.5.24[Full Changelog]

.Changed
- {url-issues}340[#340] Migrated from nexus publish plugin to maven publish plugin to publish to maven central


[[v0.5.22]]
== [0.5.22] -- 2025-09-28

{url-cl}0.5.13++...++0.5.22[Full Changelog]
